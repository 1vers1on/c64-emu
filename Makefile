...
WASM_CFLAGS := -sWASM=1 -s EXPORTED_FUNCTIONS="['_startEmulator','_getFramebuffer','_keyDown','_keyUp','_getClockSpeed','_writeToMemory','_readFromMemory']" -sMODULARIZE -sEXPORT_ES6 --no-entry -s EXPORTED_RUNTIME_METHODS="['ccall','cwrap']" -O3 -flto -sASYNCIFY
