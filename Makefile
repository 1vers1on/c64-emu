...
WASM_CFLAGS := -sWASM=1 -s EXPORTED_FUNCTIONS="['_startEmulator','_getFramebuffer','_continueEmulation']" -sMODULARIZE -sEXPORT_ES6 --no-entry -s EXPORTED_RUNTIME_METHODS="['ccall','cwrap']" -O3 -flto
